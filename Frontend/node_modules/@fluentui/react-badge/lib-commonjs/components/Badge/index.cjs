...
const _Badge = require("./Badge.cjs");
const _renderBadge = require("./renderBadge.cjs");
const _useBadge = require("./useBadge.cjs");
const _useBadgeStylesstyles = require("./useBadgeStyles.styles.cjs");
