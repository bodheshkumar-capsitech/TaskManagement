...
const _CounterBadge = require("./CounterBadge.cjs");
const _useCounterBadge = require("./useCounterBadge.cjs");
const _useCounterBadgeStylesstyles = require("./useCounterBadgeStyles.styles.cjs");
