...
const _getIntentIcon = require("./getIntentIcon.cjs");
const _useMessageBarReflow = require("./useMessageBarReflow.cjs");
const _messageBarTransitionContext = require("../../contexts/messageBarTransitionContext.cjs");
...
const useMessageBar_unstable = (props, ref)=>{
    ...
    const state = useMessageBarBase_unstable(baseProps, (0, _reactutilities.useMergedRefs)(ref, motionRef));
    return {
        ...state,
        shape,
        icon: _reactutilities.slot.optional(props.icon, {
