...
const _Caption2 = require("./Caption2.cjs");
const _Caption2Strong = require("./Caption2Strong.cjs");
const _Display = require("./Display.cjs");
const _LargeTitle = require("./LargeTitle.cjs");
const _Subtitle1 = require("./Subtitle1.cjs");
const _Subtitle2 = require("./Subtitle2.cjs");
const _Subtitle2Stronger = require("./Subtitle2Stronger.cjs");
const _Title1 = require("./Title1.cjs");
const _Title2 = require("./Title2.cjs");
const _Title3 = require("./Title3.cjs");
