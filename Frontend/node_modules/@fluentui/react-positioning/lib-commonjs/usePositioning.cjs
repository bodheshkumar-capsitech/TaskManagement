...
const _createPositionManager = require("./createPositionManager.cjs");
const _usePositioningOptions = require("./usePositioningOptions.cjs");
...
function usePositioning(options) {
        ...
        _react.useEffect(()=>{
            if (containerRef.current) {
                ...
                const treeWalker = (_contentNode_ownerDocument = contentNode.ownerDocument) === null || _contentNode_ownerDocument === void 0 ? void 0 : _contentNode_ownerDocument.createTreeWalker(contentNode, NodeFilter.SHOW_ELEMENT, {
                    acceptNode: _index.hasAutofocusFilter
                });
    ...
    const setTarget = (0, _index.useCallbackRef)(null, (target)=>{
    ...
    const setContainer = (0, _index.useCallbackRef)(null, (container)=>{
    ...
    const setArrow = (0, _index.useCallbackRef)(null, (arrow)=>{
