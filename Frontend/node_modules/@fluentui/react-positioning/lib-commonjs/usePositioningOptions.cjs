...
const _index = require("./middleware/index.cjs");
const _index1 = require("./utils/index.cjs");
const _devtools1 = require("./utils/devtools.cjs");
const _PositioningConfigurationContext = require("./PositioningConfigurationContext.cjs");
/**
...
function usePositioningOptions(options) {
    ...
    return _react.useCallback((container, arrow)=>{
        const hasScrollableElement = (0, _index1.hasScrollParent)(container);
        ...
        const normalizedAutoSize = (0, _index1.normalizeAutoSize)(autoSize);
        const middleware = [
            normalizedAutoSize && (0, _index.resetMaxSize)(normalizedAutoSize),
            matchTargetSize && (0, _index.matchTargetSize)(),
            offset && (0, _index.offset)(offset),
            coverTarget && (0, _index.coverTarget)(),
            !pinned && (0, _index.flip)({
                container,
                flipBoundary,
            ...
            normalizedAutoSize && (0, _index.maxSize)(normalizedAutoSize, {
                container,
                overflowBoundary,
                overflowBoundaryPadding,
                isRtl
            }),
            (0, _index.intersecting)(),
            arrow && (0, _dom.arrow)({
                element: arrow,
        ...
        const placement = (0, _index1.toFloatingUIPlacement)(align, position, isRtl);
        return {
            placement,
            middleware,
