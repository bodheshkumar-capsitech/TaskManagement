...
export { iconClassName, iconFilledClassName, iconRegularClassName, iconLightClassName, iconColorClassName, fontIconClassName, DATA_FUI_ICON, } from '../utils/constants.js';
export type { FluentIconsProps } from '../utils/FluentIconsProps.types.js';
export type { FluentIcon, CreateFluentIconOptions } from './createFluentIcon.js';
/**
