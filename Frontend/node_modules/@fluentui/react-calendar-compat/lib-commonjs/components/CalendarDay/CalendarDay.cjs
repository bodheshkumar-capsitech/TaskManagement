...
const _CalendarDayGrid = require("../CalendarDayGrid/CalendarDayGrid.cjs");
const _useCalendarDayStylesstyles = require("./useCalendarDayStyles.styles.cjs");
...
const CalendarDayNavigationButtons = (props)=>{
    ...
    const onSelectNextMonth = ()=>{
        onNavigateDate((0, _index.addMonths)(navigatedDate, 1), false);
    };
    const onSelectPrevMonth = ()=>{
        onNavigateDate((0, _index.addMonths)(navigatedDate, -1), false);
    };
    // determine if previous/next months are in bounds
    const prevMonthInBounds = minDate ? (0, _index.compareDatePart)(minDate, (0, _index.getMonthStart)(navigatedDate)) < 0 : true;
    const nextMonthInBounds = maxDate ? (0, _index.compareDatePart)((0, _index.getMonthEnd)(navigatedDate), maxDate) < 0 : true;
    ...
    return /*#__PURE__*/ _react.createElement("div", {
        ...
        title: strings.prevMonthAriaLabel ? strings.prevMonthAriaLabel + ' ' + strings.months[(0, _index.addMonths)(navigatedDate, -1).getMonth()] : undefined,
        type: "button"
        ...
        title: strings.nextMonthAriaLabel ? strings.nextMonthAriaLabel + ' ' + strings.months[(0, _index.addMonths)(navigatedDate, 1).getMonth()] : undefined,
        type: "button"
