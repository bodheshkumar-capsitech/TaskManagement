...
const _useCalendarYearStylesstyles = require("./useCalendarYearStyles.styles.cjs");
...
const CalendarYearGrid = (props)=>{
    ...
    return /*#__PURE__*/ _react.createElement("div", {
        ...
        return /*#__PURE__*/ _react.createElement(_calendarMotions.DirectionalSlideIn, {
            key: index,
            replayKey: fromYear,
...
function useAnimateBackwards(fromYear) {
    const previousFromYearRef = _react.useRef(undefined);
    _react.useEffect(()=>{
