...
const _AvatarGroupItem = require("./AvatarGroupItem.cjs");
const _renderAvatarGroupItem = require("./renderAvatarGroupItem.cjs");
const _useAvatarGroupItem = require("./useAvatarGroupItem.cjs");
const _useAvatarGroupItemStylesstyles = require("./useAvatarGroupItemStyles.styles.cjs");
