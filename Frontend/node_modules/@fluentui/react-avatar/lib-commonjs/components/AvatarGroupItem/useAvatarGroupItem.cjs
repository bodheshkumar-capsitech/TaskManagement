...
const _Avatar = require("../Avatar/Avatar.cjs");
const _AvatarGroupContext = require("../../contexts/AvatarGroupContext.cjs");
const _useAvatarGroup = require("../AvatarGroup/useAvatarGroup.cjs");
