...
const _AvatarGroup = require("./AvatarGroup.cjs");
const _renderAvatarGroup = require("./renderAvatarGroup.cjs");
const _useAvatarGroup = require("./useAvatarGroup.cjs");
const _useAvatarGroupStylesstyles = require("./useAvatarGroupStyles.styles.cjs");
const _useAvatarGroupContextValues = require("./useAvatarGroupContextValues.cjs");
