...
const _borderRadius = require("./borderRadius.cjs");
const _colors = require("./colors.cjs");
const _curves = require("./curves.cjs");
const _durations = require("./durations.cjs");
const _fonts = require("./fonts.cjs");
const _spacings = require("./spacings.cjs");
const _strokeWidths = require("./strokeWidths.cjs");
const _typographyStyles = require("./typographyStyles.cjs");
