...
_export(exports, {
    ...
    useMenuButtonBase_unstable: function() {
        return _useMenuButton.useMenuButtonBase_unstable;
    },
...
const _renderMenuButton = require("./renderMenuButton.cjs");
const _useMenuButton = require("./useMenuButton.cjs");
const _useMenuButtonStylesstyles = require("./useMenuButtonStyles.styles.cjs");
