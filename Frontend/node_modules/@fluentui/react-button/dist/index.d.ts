...
export declare type CompoundButtonBaseProps = ComponentProps<Partial<CompoundButtonSlots>> & Pick<ButtonBaseProps, 'disabledFocusable' | 'disabled' | 'iconPosition'>;

export declare type CompoundButtonBaseState = ComponentState<CompoundButtonSlots> & Omit<ButtonBaseState, keyof ButtonSlots | 'components'>;

export declare const compoundButtonClassNames: SlotClassNames<CompoundButtonSlots>;

export declare type CompoundButtonProps = CompoundButtonBaseProps & Pick<ButtonProps, 'appearance' | 'shape' | 'size'>;
...
export declare type CompoundButtonState = CompoundButtonBaseState & Pick<ButtonState, 'appearance' | 'shape' | 'size'>;
 ...
 */
export declare const renderCompoundButton_unstable: (state: CompoundButtonBaseState) => JSXElement;
 ...
 */
export declare const renderSplitButton_unstable: (state: Pick<ComponentState<SplitButtonBaseSlots>, "root" | "menuButton" | "primaryActionButton">) => JSXElement;
 ...
 */
export declare type SplitButtonBaseProps = ComponentProps<SplitButtonBaseSlots> & Pick<ButtonBaseProps, 'disabled' | 'disabledFocusable' | 'icon' | 'iconPosition'> & Pick<MenuButtonBaseProps, 'menuIcon'>;

export declare type SplitButtonBaseSlots = {
    /**
 ...
 */
export declare type SplitButtonBaseState = ComponentState<SplitButtonBaseSlots> & Required<Pick<SplitButtonBaseProps, 'disabled' | 'disabledFocusable' | 'iconPosition'>>;
 ...
 * @param ref - User provided ref to be passed to the CompoundButton component.
 */
export declare const useCompoundButtonBase_unstable: (props: CompoundButtonBaseProps, ref?: React_2.Ref<HTMLButtonElement | HTMLAnchorElement>) => CompoundButtonBaseState;
 ...
 */
export declare const useSplitButton_unstable: (props: SplitButtonProps, ref: React_2.Ref<HTMLDivElement>) => SplitButtonState;
 ...
 * @param ref - User provided ref to be passed to the SplitButton component.
 */
export declare const useSplitButtonBase_unstable: (props: SplitButtonBaseProps, ref: React_2.Ref<HTMLDivElement>) => SplitButtonBaseState;
