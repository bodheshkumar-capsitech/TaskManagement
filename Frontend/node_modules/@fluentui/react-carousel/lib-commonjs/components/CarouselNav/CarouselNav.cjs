...
const _useCarouselNavContextValues = require("./useCarouselNavContextValues.cjs");
const _renderCarouselNav = require("./renderCarouselNav.cjs");
const _useCarouselNav = require("./useCarouselNav.cjs");
const _useCarouselNavStylesstyles = require("./useCarouselNavStyles.styles.cjs");
...
const CarouselNav = /*#__PURE__*/ _react.forwardRef((props, ref)=>{
    ...
    const contextValues = (0, _useCarouselNavContextValues.useCarouselNavContextValues_unstable)(state);
