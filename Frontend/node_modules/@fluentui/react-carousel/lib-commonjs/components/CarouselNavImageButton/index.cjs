...
const _renderCarouselNavImageButton = require("./renderCarouselNavImageButton.cjs");
const _useCarouselNavImageButton = require("./useCarouselNavImageButton.cjs");
const _useCarouselNavImageButtonStylesstyles = require("./useCarouselNavImageButtonStyles.styles.cjs");
