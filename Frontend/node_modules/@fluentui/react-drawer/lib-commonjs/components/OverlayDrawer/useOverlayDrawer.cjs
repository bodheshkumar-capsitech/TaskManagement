...
const _drawerMotions = require("../../shared/drawerMotions.cjs");
const _useDrawerDefaultProps = require("../../shared/useDrawerDefaultProps.cjs");
const _index = require("./OverlayDrawerSurface/index.cjs");
const _drawerMotionUtils = require("../../shared/drawerMotionUtils.cjs");
const STATIC_MOTION = {
    active: true,
    canRender: true,
...
const useOverlayDrawer_unstable = (props, ref)=>{
    ...
    const root = _reactutilities.slot.always({
        ...
        elementType: _index.OverlayDrawerSurface
    });
    ...
    return {
        components: {
            root: _index.OverlayDrawerSurface,
