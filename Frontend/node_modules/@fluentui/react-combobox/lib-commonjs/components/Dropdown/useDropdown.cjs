...
const _useComboboxPositioning = require("../../utils/useComboboxPositioning.cjs");
const _Listbox = require("../Listbox/Listbox.cjs");
const _useListboxSlot = require("../../utils/useListboxSlot.cjs");
const _useButtonTriggerSlot = require("./useButtonTriggerSlot.cjs");
const _isComboboxOptionElement = require("../../utils/isComboboxOptionElement.cjs");
const _useTabsterEscapeIgnore = require("../../hooks/useTabsterEscapeIgnore.cjs");
...
const useDropdown_unstable = (props, ref)=>{
    ...
    return {
        ...
        size,
        button: {
            ...(0, _useTabsterEscapeIgnore.useTabsterEscapeIgnore)(baseState.button, baseState.open),
            ...baseState.button
        }
    };
};
