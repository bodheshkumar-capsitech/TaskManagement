...
const _useTable = require("../Table/useTable.cjs");
const _reactutilities = require("@fluentui/react-utilities");
const _keyboardkeys = require("@fluentui/keyboard-keys");
const _index = require("../../hooks/index.cjs");
const _index1 = require("../TableSelectionCell/index.cjs");
const useDataGrid_unstable = (props, ref)=>{
    ...
    const widthOffset = containerWidthOffset !== null && containerWidthOffset !== void 0 ? containerWidthOffset : selectionMode ? -_index1.CELL_WIDTH : 0;
    const gridTabsterAttribute = (0, _reacttabster.useArrowNavigationGroup)({
        axis: 'grid'
    });
    const { onTableKeyDown: onCompositeKeyDown, tableTabsterAttribute: compositeTabsterAttribute, tableRowTabsterAttribute: compositeRowTabsterAttribute } = (0, _index.useTableCompositeNavigation)();
    var _resizableColumnsOptions_autoFitColumns;
    const tableState = (0, _index.useTableFeatures)({
        items,
        columns,
        getRowId
    }, [
        (0, _index.useTableSort)({
            defaultSortState,
            sortState,
            onSortChange
        }),
        (0, _index.useTableSelection)({
            defaultSelectedItems,
            selectedItems,
            onSelectionChange,
            selectionMode: selectionMode !== null && selectionMode !== void 0 ? selectionMode : 'multiselect'
        }),
        (0, _index.useTableColumnSizing_unstable)({
            onColumnResize,
            columnSizingOptions,
