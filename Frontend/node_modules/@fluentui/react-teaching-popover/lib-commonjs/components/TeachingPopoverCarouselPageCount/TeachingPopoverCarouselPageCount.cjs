...
const _useTeachingPopoverCarouselPageCount = require("./useTeachingPopoverCarouselPageCount.cjs");
const _renderTeachingPopoverCarouselPageCount = require("./renderTeachingPopoverCarouselPageCount.cjs");
const _useTeachingPopoverCarouselPageCountStylesstyles = require("./useTeachingPopoverCarouselPageCountStyles.styles.cjs");
...
const TeachingPopoverCarouselPageCount = /*#__PURE__*/ _react.forwardRef((props, ref)=>{
    ...
    (0, _reactsharedcontexts.useCustomStyleHook_unstable)('useTeachingPopoverCarouselPageCountStyles_unstable')(state);
