...
const _RatingItem = require("./RatingItem.cjs");
const _renderRatingItem = require("./renderRatingItem.cjs");
const _useRatingItem = require("./useRatingItem.cjs");
const _useRatingItemStylesstyles = require("./useRatingItemStyles.styles.cjs");
