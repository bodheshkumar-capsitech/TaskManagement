...
const _useAppItem = require("./useAppItem.cjs");
const _renderAppItem = require("./renderAppItem.cjs");
const _useAppItemStylesstyles = require("./useAppItemStyles.styles.cjs");
