...
const _renderAppItemStatic = require("./renderAppItemStatic.cjs");
const _useAppItemStatic = require("./useAppItemStatic.cjs");
const _useAppItemStaticStylesstyles = require("./useAppItemStaticStyles.styles.cjs");
