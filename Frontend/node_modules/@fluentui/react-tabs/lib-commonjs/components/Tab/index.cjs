...
const _Tab = require("./Tab.cjs");
const _renderTab = require("./renderTab.cjs");
const _useTab = require("./useTab.cjs");
const _useTabStylesstyles = require("./useTabStyles.styles.cjs");
const _useTabAnimatedIndicatorstyles = require("./useTabAnimatedIndicator.styles.cjs");
