...
function useTreeItem_unstable(props, ref) {
    ...
    const navigationMode = (0, _index.useTreeContext_unstable)((ctx)=>{
    ...
    const forceUpdateRovingTabIndex = (0, _index.useTreeContext_unstable)((ctx)=>ctx.forceUpdateRovingTabIndex);
    const { level: contextLevel } = (0, _index.useSubtreeContext_unstable)();
    ...
    if (process.env.NODE_ENV !== 'production') {
        ...
        const hasTreeContext = (0, _reactcontextselector.useHasParentContext)(_index.TreeContext);
        // eslint-disable-next-line react-hooks/rules-of-hooks
        _react.useEffect(()=>{
