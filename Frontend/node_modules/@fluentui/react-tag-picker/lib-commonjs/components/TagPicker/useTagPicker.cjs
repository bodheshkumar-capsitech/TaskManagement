...
_export(exports, {
    useTagPickerBase_unstable: function() {
        return useTagPickerBase_unstable;
    },
...
const useTagPickerBase_unstable = (props)=>{
    ...
    const passiveTargetRef = _react.useRef(null);
    ...
    return {
        ...
        popoverRef: (0, _reactutilities.useMergedRefs)(listboxRef),
        secondaryActionRef,
        tagPickerGroupRef,
...
const useTagPicker_unstable = (props)=>{
    ...
    return {
        ...
        inline,
        targetRef,
        popoverRef: (0, _reactutilities.useMergedRefs)(baseState.popoverRef, containerRef)
    };
};
