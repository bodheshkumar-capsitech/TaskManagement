...
_export(exports, {
    useTagPickerControlBase_unstable: function() {
        return useTagPickerControlBase_unstable;
    },
...
const _useTagPickerControlStylesstyles = require("./useTagPickerControlStyles.styles.cjs");
const _TagPickerContext = require("../../contexts/TagPickerContext.cjs");
const _useExpandLabel = require("../../utils/useExpandLabel.cjs");
const _useResizeObserverRef = require("../../utils/useResizeObserverRef.cjs");
const useTagPickerControlBase_unstable = (props, ref)=>{
...
const useTagPickerControl_unstable = (props, ref)=>{
    ...
    const baseProps = !noPopover && props.expandIcon === undefined ? {
        ...props,
        expandIcon: /*#__PURE__*/ _react.createElement(_reacticons.ChevronDownRegular, null)
    } : props;
