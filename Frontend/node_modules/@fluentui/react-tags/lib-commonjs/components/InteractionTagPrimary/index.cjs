...
_export(exports, {
    ...
    useInteractionTagPrimaryBase_unstable: function() {
        return _useInteractionTagPrimary.useInteractionTagPrimaryBase_unstable;
    },
...
const _renderInteractionTagPrimary = require("./renderInteractionTagPrimary.cjs");
const _useInteractionTagPrimary = require("./useInteractionTagPrimary.cjs");
const _useInteractionTagPrimaryStylesstyles = require("./useInteractionTagPrimaryStyles.styles.cjs");
