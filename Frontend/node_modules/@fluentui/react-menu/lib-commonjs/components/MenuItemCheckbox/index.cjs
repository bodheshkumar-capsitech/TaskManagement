...
_export(exports, {
    ...
    useMenuItemCheckboxBase_unstable: function() {
        return _useMenuItemCheckbox.useMenuItemCheckboxBase_unstable;
    },
...
const _renderMenuItemCheckbox = require("./renderMenuItemCheckbox.cjs");
const _useMenuItemCheckbox = require("./useMenuItemCheckbox.cjs");
const _useMenuItemCheckboxStylesstyles = require("./useMenuItemCheckboxStyles.styles.cjs");
